...
const BachelorBacheloretteLimousineServices = () => {
    const services = [
        {
            icon: Shield,
            title: 'Luxury Party Transportation',
            description:
                'Celebrate your upcoming marriage in style with our limousines and party buses.',
        },
        {
            icon: Clock,
            title: '24/7 Availability',
            description:
                'Our services are available around the clock to accommodate your party plans.',
        },
        {
            icon: Award,
            title: 'Experienced Chauffeurs',
            description:
                'Licensed chauffeurs ensure a safe and enjoyable experience for your celebration.',
        },
        {
            icon: Phone,
            title: 'Free Consultations',
            description:
                'Contact us for a free consultation or quote for your bachelor or bachelorette party transportation.',
        },
    ]
        ...
        <div>
            <div className="HomeContainer bg-custom-gradient-2 w-screen min-h-screen overflow-x-hidden">
                ...
                <div
                    ...
                    style={{
                        backgroundImage:
                            'url(/src/assets/images/bachelor-limousine.jpg)',
                    }}
                >
                    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 bg-cover bg-center bg-no-repeat">
                        <div className="max-w-3xl">
                            ...
                            <p className="text-xl text-white mb-8">
                                Celebrate Your Upcoming Marriage in a Limo or a
                                Party Bus! Dynasty Limousine wants your final
                                moments before getting married to be memorable.
                                What better way than to ride in a high-society
                                limousine or a party bus?! We have various
                                models available for seating numerous people and
                                our limousine is stocked with beverages.
                            </p>
                            <button
                ...
                <section className="bg-custom-gradient-2 from-gray-900 to-gray-800 py-20">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <img
                                    src="../../../src/assets/images/bachelor-limousine.jpg"
                                    alt="Luxury bachelor and bachelorette fleet"
...
export default BachelorBacheloretteLimousineServices
