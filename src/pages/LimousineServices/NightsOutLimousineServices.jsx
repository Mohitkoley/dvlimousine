...
const NightsOutLimousineServices = () => {
    const services = [
        {
            icon: Shield,
            title: 'Luxury Night Out Transportation',
            description:
                'Enjoy a classy ride to explore the nightlife of New York City.',
        },
        {
            icon: Clock,
            title: '24/7 Availability',
            description:
                'Our services are available around the clock to accommodate your night out plans.',
        },
        {
            icon: Award,
            title: 'Experienced Chauffeurs',
            description:
                'Licensed chauffeurs ensure a safe and enjoyable experience during your night out.',
        },
        {
            icon: Phone,
            title: 'Free Consultations',
            description:
                'Contact us for a free consultation or quote for your night out transportation.',
        },
    ];
    ...
    return (
        <div>
            <div className="HomeContainer bg-custom-gradient-2 w-screen min-h-screen overflow-x-hidden">
                ...
                <div className="relative bg-cover bg-center bg-no-repeat" style={{backgroundImage:'url(/src/assets/images/nightsout-limousine.jpg)',}}>
                    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 bg-cover bg-center bg-no-repeat">
                        <div className="max-w-3xl">
                            <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6">
                                Limousine Service for Nights Out on the Town
                            </h1>
                            ...
                            <p className="text-xl text-white mb-8">
                                Ride in a Classy Limo to Check Out New York
                                If you&apos;re looking to have a great night in New York, Dynasty Limousine invites you to see the scenery while riding in one of our limos. Stocked with beverages, our limos will provide a smooth, luxurious ride for you and your friends while you are sightseeing.
                            </p>
                            <button
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-gray-300 max-w-2xl mx-auto">
                                Experience luxury transportation with our comprehensive range of services designed for your comfort and convenience.
                            </p>
                        </div>
                ...
                <section className="bg-custom-gradient-2 from-gray-900 to-gray-800 py-20">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <img
                                    src="../../../src/assets/images/nightsout-limousine.jpg"
                                    alt="Luxury night out fleet"
                                    className="rounded-lg shadow-2xl w-full"
                                />
                            </div>
                            <div>
                                <h2 className="text-3xl font-bold text-white mb-6">
                                    What Our Agreement Entails
                                </h2>
...
export default NightsOutLimousineServices
